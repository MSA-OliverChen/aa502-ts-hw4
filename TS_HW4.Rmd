...
```{r}
# theoretically, we could test k in [1, 365 // 2] but this would likely cause
# diminishing returns after a few K.

# we can see through this search up through K=10 that we already
# reached a local minimum of AICc
...
Seems like the best harmonic frequency for weekly seasonality is $K=3$.

Let's also try to do a grid search.
